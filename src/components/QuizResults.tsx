  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-gray-600">{getScoreMessage(result.score)}</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              ...
              <span className="text-gray-800">{formatTime(result.timeSpent)}</span>
            </div>
            
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <span className="font-medium">Average per Question</span>
              <span className="text-gray-800">{formatTime(result.timeSpent / result.totalQuestions)}</span>
            </div>
          </div>
        </div>
        ...
        {/* Results Chart */}
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h2 className="text-xl font-semibold mb-6">Results Breakdown</h2>
          <div className="h-64">
      ...
      <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {feedback.improvements.length > 0 && (
            <div>
              <h3 className="font-semibold text-red-700 mb-3">Areas for Improvement 📚</h3>
              <ul className="space-y-2">
      ...
      <div className="text-center">
        <button
          onClick={onRestart}
          className="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold flex items-center space-x-2 mx-auto transition-all duration-200 shadow-lg hover:shadow-xl"
        >
